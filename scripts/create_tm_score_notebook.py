#!/usr/bin/env python
"""
Script to create a Jupyter notebook for TM-score visualization.
"""
...
def main():
    ...
    # Path for the notebook
    notebook_path = notebooks_dir / "tm_score_visualization.ipynb"
    
    # Write the notebook to file
    with open(notebook_path, 'w') as f:
        json.dump(notebook, f, indent=1)
    
    print(f"Created notebook at: {notebook_path.absolute()}")
